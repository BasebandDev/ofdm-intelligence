...
# Models
class UncodedBPSKAWGN(sionna.phy.Block):
...
class UncodedOFDM_BPSKAWGN(sionna.phy.Block):
...
model_ofdm_bpsk_awgn = UncodedOFDM_BPSKAWGN(num_bits_per_symbol=NUM_BITS_PER_SYMBOL) #m1
model_bpsk_awgn      = UncodedBPSKAWGN(num_bits_per_symbol=NUM_BITS_PER_SYMBOL, block_length=model_ofdm_bpsk_awgn.block_length) #m2
...
mc_snrs_bpsk_awgn = ber_plots._snrs[0]        # Eb/N0 values for BPSK on AWGN curve
mc_bers_bpsk_awgn = ber_plots._bers[0]        # BER values for BPSK on AWGN curve
mc_snrs_bpsk_ofdm_awgn = ber_plots._snrs[1]   # Eb/N0 values for BPSK+OFDM on AWGN curve
mc_bers_bpsk_ofdm_awgn = ber_plots._bers[1]   # BER values for BPSK+OFDM on AWGN curve
...
ax.semilogy(mc_snrs_bpsk_awgn, mc_bers_bpsk_awgn, 'bo-',
            linewidth=2, markersize=5, label="BPSK over AWGN Channel -Monte Carlo")
ax.semilogy(mc_snrs_bpsk_ofdm_awgn, mc_bers_bpsk_ofdm_awgn, 'gs-',
            linewidth=2, markersize=5, label="BPSK+OFDM over AWGN Channel - Monte Carlo")
